...
<%
      //phone number from session
		...
		String query="select * from consumer where phone=?";
		OutputStream sos=null;
		byte[] img=null;
		try
		{
			%>
			<form  method="post" action="UpdateProfileCus1" onclick="GFG_Fun()" enctype="multipart/form-data">
			<img id="output" src="UpdateProfileCus" style="width:150px;height:150px;border-radius:50%;display: inline;">
